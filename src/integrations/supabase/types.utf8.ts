  ...
  public: {
    Tables: {
      ...
      round_scores: {
        ...
        Relationships: [
          {
            foreignKeyName: "round_scores_active_member_id_fkey"
    ...
    Functions: {
      clone_game_questions: {
        Args: { _source_game_id: string; _target_game_id: string }
        Returns: undefined
      }
      flag_team_disqualification: {
        Args: { _game_id: string; _team_id: string }
        Returns: undefined
      }
      has_role: {
        Args: {
